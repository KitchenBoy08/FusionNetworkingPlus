    ...
    public class Message
    {
        ...
        public Message SkipBits(int amount)
        {
            if (UnreadBits < amount)
                RiptideLogger.Log(Utils.LogType.Error, $"Message only contains {UnreadBits} unread {Helper.CorrectForm(UnreadBits, "bit")}, which is not enough to skip {amount}!");
        ...
        public byte GetByte()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(ByteName, $"{default(byte)}"));
                return default;
            }
        ...
        public sbyte GetSByte()
        {
            if (UnreadBits < BitsPerByte)
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(SByteName, $"{default(sbyte)}"));
                return default;
            }
        ...
        private void ReadBytes(int amount, byte[] intoArray, int startIndex = 0)
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, ByteName));
        ...
        private void ReadSBytes(int amount, sbyte[] intoArray, int startIndex = 0)
        {
            if (UnreadBits < amount * BitsPerByte)
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, SByteName));
                amount = UnreadBits / BitsPerByte;
            }
        ...
        public bool GetBool()
        {
            if (UnreadBits < 1)
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(BoolName, $"{default(bool)}"));
                return default;
            }
        ...
        private void ReadBools(int amount, bool[] intoArray, int startIndex = 0)
        {
            if (UnreadBits < amount)
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, BoolName));
                amount = UnreadBits;
            }
        ...
        public short GetShort()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(ShortName, $"{default(short)}"));
                return default;
            }
        ...
        public ushort GetUShort()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(UShortName, $"{default(ushort)}"));
                return default;
            }
        ...
        private void ReadShorts(int amount, short[] intoArray, int startIndex = 0)
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, ShortName));
        ...
        private void ReadUShorts(int amount, ushort[] intoArray, int startIndex = 0)
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, UShortName));
        ...
        public int GetInt()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(IntName, $"{default(int)}"));
                return default;
            }
        ...
        public uint GetUInt()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(UIntName, $"{default(uint)}"));
                return default;
            }
        ...
        private void ReadInts(int amount, int[] intoArray, int startIndex = 0)
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, IntName));
        ...
        private void ReadUInts(int amount, uint[] intoArray, int startIndex = 0)
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, UIntName));
        ...
        public long GetLong()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(LongName, $"{default(long)}"));
                return default;
            }
        ...
        public ulong GetULong()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(ULongName, $"{default(ulong)}"));
                return default;
            }
        ...
        private void ReadLongs(int amount, long[] intoArray, int startIndex = 0)
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, LongName));
        ...
        private void ReadULongs(int amount, ulong[] intoArray, int startIndex = 0)
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, ULongName));
        ...
        public float GetFloat()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(FloatName, $"{default(float)}"));
                return default;
            }
        ...
        private void ReadFloats(int amount, float[] intoArray, int startIndex = 0)
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, FloatName));
        ...
        public double GetDouble()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(DoubleName, $"{default(double)}"));
                return default;
            }
        ...
        private void ReadDoubles(int amount, double[] intoArray, int startIndex = 0)
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(amount, DoubleName));
        ...
        public string GetString()
        {
            ...
            {
                RiptideLogger.Log(Utils.LogType.Error, NotEnoughBitsError(StringName, "shortened string"));
